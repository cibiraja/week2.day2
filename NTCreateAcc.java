...
public class NTCreateAcc {
	public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//input[@id='currentcyUomId']")).sendKeys("Indian Rupee");
        driver.findElement(By.xpath("//textarea[@name='description']")).sendKeys("NRI Account");
        driver.findElement(By.xpath("//input[@id='officeSiteName']")).sendKeys("Cibi");
        driver.findElement(By.xpath("//input[@='groupNameLocal']")).sendKeys("Group 1");
