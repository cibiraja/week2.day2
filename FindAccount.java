...
public class FindAccount {
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@name='accountName'])[2]")).sendKeys("Create Limited Account");
		driver.findElement(By.xpath("//button[contains(text(),'Find Accounts')]")).click();
		String accountName=driver.findElement(By.xpath("//span[contains(text(),'Credit Limited Account (accountlimi150)')]")).getText();
